...
#ifndef STM32F1XX_NUCLEO_BUS_H
#define STM32F1XX_NUCLEO_BUS_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32f1xx_nucleo_conf.h"
#include "stm32f1xx_nucleo_errno.h"
...
/** @defgroup STM32F1XX_NUCLEO_BUS STM32F1XX_NUCLEO BUS
  * @{
  */

/** @defgroup STM32F1XX_NUCLEO_BUS_Exported_Constants STM32F1XX_NUCLEO BUS Exported Constants
  * @{
  */

#define BUS_I2C1_INSTANCE I2C1
#define BUS_I2C1_SCL_GPIO_PIN GPIO_PIN_8
#define BUS_I2C1_SCL_GPIO_AF __HAL_AFIO_REMAP_I2C1_ENABLE
...
#define BUS_I2C1_SDA_GPIO_AF __HAL_AFIO_REMAP_I2C1_ENABLE
...
/** @defgroup STM32F1XX_NUCLEO_BUS_Private_Types STM32F1XX_NUCLEO BUS Private types
  * @{
  */
...
/** @defgroup STM32F1XX_NUCLEO_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @addtogroup STM32F1XX_NUCLEO_BUS_Exported_Functions
  * @{
  */    
